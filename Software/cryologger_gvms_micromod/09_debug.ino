...
void printGnssSettings()
{
  ...
  DEBUG_PRINT("RAWX: ");          printTab(2);  DEBUG_PRINTLN(gnss.getVal32(UBLOX_CFG_MSGOUT_UBX_RXM_RAWX_UART1));
  DEBUG_PRINT("SFRBX: ");         printTab(2);  DEBUG_PRINTLN(gnss.getVal32(UBLOX_CFG_MSGOUT_UBX_RXM_SFRBX_UART1));
  DEBUG_PRINT("NAV-PVT: ");       printTab(2);  DEBUG_PRINTLN(gnss.getVal32(UBLOX_CFG_MSGOUT_UBX_NAV_PVT_UART1));
  DEBUG_PRINT("RAWX I2C: ");         printTab(2);  DEBUG_PRINTLN(gnss.getVal32(UBLOX_CFG_MSGOUT_UBX_RXM_RAWX_I2C));
